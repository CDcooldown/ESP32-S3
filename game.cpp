...
{
    /*Create 2048 game*/
    lv_obj_t * obj_2048 = lv_100ask_2048_create(ui_Game);
#if LV_FONT_MONTSERRAT_40    
    lv_obj_set_style_text_font(obj_2048, &lv_font_montserrat_40, 0);
#endif
    lv_obj_set_size(obj_2048, 200, 200);
    lv_obj_center(obj_2048);
    lv_obj_align_to(obj_2048, ui_Game, LV_ALIGN_CENTER, 0, 10);

    /*Information*/
    lv_obj_t * label = lv_label_create(ui_Game);
    ...
    /*New Game*/
    lv_obj_t * btn = lv_btn_create(ui_Game);
